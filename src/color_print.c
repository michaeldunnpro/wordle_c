...
/**
 * Prints a string with the specified foreground color, background color, and
 * style. After printing, the color and style are reset to default. An empty
 * string can be passed to ignore an attribute.
 *
 * Parameters:
...
/**
 * Prints a Wordle word with each character colored according to the correctness
 * string.
 *
 * Parameters:
 *   string - The Wordle word to be printed
 *   correctness - A string indicating the correctness of each character ('G'
 * for green, 'Y' for yellow, 'B' for black)
 *
 * Returns:
 *   The number of characters printed.
 */
